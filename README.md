...
The repository root is the runnable Flutter application. A previous incomplete
prototype is retained under `legacy/root-prototype/` for reference only; it is
